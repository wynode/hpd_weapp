<template>
  <div>
    <div class="home_top">
      <image
        class="home_top_img"
        src="/static/images/首页icon/icon-sy-ad@3x.png"
      ></image>
      <div class="home_top_ab">
        <div class="hta_left">
          <image
            class="hta_location"
            src="/static/images/首页icon/icon-sy-address@3x.png"
          />
          <text class="hta_text">上海</text>
          <image
            class="hta_bottom"
            src="/static/images/首页icon/icon-sy-bottom@3x.png"
          />
        </div>

        <van-search
          class="hta_search"
          left-icon="/static/images/首页icon/icon-sy-search@3x.png"
          shape="round"
    ...
    <div class="home_s1">
      <div class="home_s1_left"></div>
      <div class="home_s1_right"></div>
    </div>
    <div class="home_s2">
      <div v-for="item in s2List" :key="item" class="home_s2_item">
        <image :src="item.url" class="home_s2_img"></image>
        <text class="home_s2_text">{{ item.name }}</text>
      </div>
    </div>
    <div class="home_s3">
      <image
        src="/static/images/首页icon/icon-sy-ad2@3x.png"
        class="home_s3_img"
      ></image>
      <image
        src="/static/images/首页icon/icon-sy-ad1@3x.png"
        class="home_s3_img"
      ></image>
    </div>
    <div class="home_s4">
      <image
        src="/static/images/首页icon/icon-sy-tt@3x.png"
        class="home_s4_img"
      ></image>
...
export default {
  ...
  data() {
    return {
      s2List: [
        {
          url: "/static/images/首页icon/icon-sy-zd@3x.png",
          name: "转店服务",
        },
        {
          url: "/static/images/首页icon/icon-sy-zdfw@3x.png",
          name: "找店服务",
        },
        {
          url: "/static/images/首页icon/icon-sy-xz@3x.png",
          name: "闲置物品",
        },
        {
          url: "/static/images/首页icon/icon-sy-pp@3x.png",
          name: "品牌合作",
        },
        {
          url: "/static/images/首页icon/icon-sy-zx@3x.png",
          name: "装修",
        },
      ],
    };
...
.home_s12_content div {
  width: 310px;
  height: 314px;
  box-shadow: 0px 5px 6px 0px rgba(6, 0, 1, 0.2);
  border-radius: 6px;
}
.home_s12_content img {
  width: 310px;
  height: 190px;
}
.home_s12_content p {
