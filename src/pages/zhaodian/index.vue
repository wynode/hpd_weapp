<template>
  <div class="service" style="background-image: url('http://wynode.com/haopuduo/找店服务icon/icon-zd-bg@3x.png')">
    ...
    <div class="ser_s1" style="background-image: url('http://wynode.com/haopuduo/找店服务icon/icon-zd-xqdj-bg@3x.png')">
      ...
      <div class="ser_s1_btn" @click="gozhaodianxuqiu">
    ...
    <div class="ser_s3">
      <div class="ser_s3_1" style="background-image: url('http://wynode.com/haopuduo/找店服务icon/icon-zd-hy-bg@3x.png')">
        <div class="ser_s3_btn" @click="gokaitong" style="background-image: url('http://wynode.com/haopuduo/找店服务icon/icon-zd-btn@3x.png')">
          <p>开通找店会员</p>
        </div>
      </div>
      <div class="ser_s3_2" style="background-image: url('http://wynode.com/haopuduo/找店服务icon/icon-zd-kf-bg@3x.png')">
        <div class="ser_s3_btn2" style="background-image: url('http://wynode.com/haopuduo/找店服务icon/icon-zd-btn@3x.png')">
          <p>立即咨询</p>
        </div>
      </div>
    </div>
    <div class="ser_s4">
      ...
      <div class="ser_s4_2">
        <h2>专业顾问为你服务</h2>
        <p>查看更多顾问
          <img src="http://wynode.com/haopuduo/找店服务icon/icon-zd-more@3x.png" alt="">
        </p>
      </div>
      <div class="ser_s4_3">
        <div>
...
<script>
  export default {
    methods: {
      ...
      gozhaodianxuqiu() {
        const url = "/pages/zhaodianxuqiu/main";
        mpvue.navigateTo({
          url
        });
      }
